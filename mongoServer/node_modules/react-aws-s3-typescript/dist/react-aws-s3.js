...
var ReactS3Client = /** @class */ (function () {
    ...
    ReactS3Client.prototype.uploadFile = function (file, newFileName) {
        return __awaiter(this, void 0, void 0, function () {
            var fileExtension, fileName, dirName, key, url, command, response, err_1;
    ...
    ReactS3Client.prototype.deleteFile = function (key) {
        return __awaiter(this, void 0, void 0, function () {
            var command, response, statusCode, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                    ...
                    case 1:
                        response = _a.sent();
                        statusCode = response.$metadata.httpStatusCode || 400;
                        return [2 /*return*/, Promise.resolve({
    ...
    ReactS3Client.prototype.listFiles = function () {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var url, command, response, err_3;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        command = new client_s3_1.ListObjectsCommand({
                            Bucket: this.config.bucketName,
                        });
                        return [4 /*yield*/, this.s3Client.send(command)];
                    case 2:
                        ...
                        return [2 /*return*/, Promise.resolve({
                                ...
                                data: __assign(__assign({}, response), { Contents: ((_a = response.Contents) === null || _a === void 0 ? void 0 : _a.map(function (e) { return (__assign(__assign({}, e), { publicUrl: url + "/" + e.Key })); })) || [] }),
                            })];
                    case 3:
                        err_3 = _b.sent();
                        return [2 /*return*/, Promise.reject({
